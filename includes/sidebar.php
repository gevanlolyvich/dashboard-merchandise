...
<nav class="shell-sidebar" id="sidebar">
    ...
    <a href="<?= BASE_URL ?>/product-analysis"
        class="nav-item <?= $currentPage == 'product-analysis' ? 'active' : '' ?>">
        <span class="nav-icon"><?= navIcon('product') ?></span>
        <span>Analisis Produk</span>
    </a>
    <a href="<?= BASE_URL ?>/customer-analysis"
        class="nav-item <?= $currentPage == 'customer-analysis' ? 'active' : '' ?>">
        <span class="nav-icon"><?= navIcon('customer') ?></span>
        <span>Analisis Customer</span>
    </a>
    <a href="<?= BASE_URL ?>/marketplace-dashboard"
        class="nav-item <?= $currentPage == 'marketplace-dashboard' ? 'active' : '' ?>">
        <span class="nav-icon">
            <?= navIcon('marketplace') ?>
        </span>
    ...
    <a href="<?= BASE_URL ?>/merchandise-jff-dashboard"
        class="nav-item <?= $currentPage == 'merchandise-jff-dashboard' ? 'active' : '' ?>">
        <span class="nav-icon">
            <?= navIcon('jff') ?>
        </span>
    ...
    <?php if ($userRole !== 'user'): ?>
        ...
        <a href="<?= BASE_URL ?>/merchandise-jff-import"
            class="nav-item <?= $currentPage == 'merchandise-jff-import' ? 'active' : '' ?>">
