...
try {
    ...
    $pdo->exec("CREATE DATABASE IF NOT EXISTS dashboard_merchandise CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci");
    $pdo->exec("USE dashboard_merchandise");
    ...
    if ($stmt->fetchColumn() == 0) {
        $pdo->exec("INSERT INTO users (username, password, display_name, role)
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS opd_customers (
      id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS bumd_customers (
      id INT AUTO_INCREMENT PRIMARY KEY,
      name VARCHAR(255) NOT NULL,
      address TEXT DEFAULT NULL,
      pic_name VARCHAR(255) DEFAULT NULL,
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS sales_opd (
      id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS sales_opd_items (
      id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS merchandise_jff (
      id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS sales_bumd (
      id INT AUTO_INCREMENT PRIMARY KEY,
      transaction_number VARCHAR(50) NOT NULL UNIQUE,
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS sales_bumd_items (
      id INT AUTO_INCREMENT PRIMARY KEY,
